  ...
  ?>
	 ...
	 ?>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
       <?php 
      echo '<label>' .$row['student_name'] .'</label>';
       }
	 ?>
                  </div>
                </div>
...
<a href="#" data-toggle="modal" data-target="#edit">Edit</a>
        ...
        <div class="row">
          <div class="col-md-6 col-md-offset-3">
            <a href="student_dashboard.php"><button type="button" class="btn btn-register">Save Changes</button></a>
          </div>
        </div>
    </div>
    </div>
