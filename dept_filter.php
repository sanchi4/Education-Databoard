...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="home">
    ...
    <div class="w3-section w3-bottombar w3-padding-16">
      ...
      <button class="w3-button w3-black w3-hide-small" data-toggle="modal" data-target="#mymodal3"></i>Department Specific</button>
    </div>
    </div>
  </header>
...
<div class="container">
    <hr><hr>
    <div class="row">
      <h5><b>Department specific search : </b></h5>
      <hr>
    </div>
	...
	$var=$_POST["dept"];
	include 'connection.php';
$query ="SELECT * FROM lecture,person_data where lecture.teacher_id=person_data.teacher_id and lecture.dept='$var'";
