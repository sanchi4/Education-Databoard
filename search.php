...
<div class="container">
	...
	echo '<b><h3>Searched string : ' . $variable . '</h3></b>';
$query ="SELECT * FROM lecture,person_data where lecture.teacher_id=person_data.teacher_id and lecture.lecture_title LIKE '%{$variable}%'";
