...
<div class="w3-main" style="margin-left:300px">
  ...
  <header id="home">
    ...
    <div class="w3-section w3-bottombar w3-padding-16">
      ...
      <button class="w3-button w3-black" data-toggle="modal" data-target="#mymodal1">Institute Specific</button>
...
<div class="container">
    <hr><hr>
    <div class="row">
      <h5><b>Institute specific search : </b></h5>
      <hr>
    </div>
	...
	$var=$_POST["inst"];
	include 'connection.php';
$query ="SELECT * FROM lecture,person_data where lecture.teacher_id=person_data.teacher_id and lecture.institute_id='$var'";
